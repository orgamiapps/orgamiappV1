...
class ThemeProvider extends ChangeNotifier {
  ...
  List<Color> getGradientColors(BuildContext context) {
    return _isDarkMode
        ...
        : [const Color(0xFF2563EB), const Color(0xFF0F766E)];
  }
  ...
  Color getWarningColor(BuildContext context) {
    return _isDarkMode ? const Color(0xFFFFA726) : const Color(0xFFF57C00);
  }

  Color getInfoColor(BuildContext context) {
    return _isDarkMode ? const Color(0xFF29B6F6) : const Color(0xFF0277BD);
  }
