...
class RecommendationAnalytics {
  ...
  static Future<void> trackRecommendationsShown({
    ...
    try {
      ...
      print('Error tracking recommendations shown: $e');
    }
  }
  ...
  static Future<void> trackRecommendationPerformance({
    ...
    try {
      ...
      print('Error tracking recommendation performance: $e');
    }
  }
  ...
  static Future<Map<String, dynamic>> getRecommendationInsights() async {
    try {
      ...
      if (totalRecommendations > 0) {
        insights['engagementRate'] = interactions.docs.length / totalRecommendations;
      }

      return insights;
    } catch (e) {
      print('Error getting recommendation insights: $e');
      return {};
    }
  }
  ...
  static Future<void> trackRecommendationFeedback({
    ...
    try {
      ...
      print('Error tracking recommendation feedback: $e');
    }
  }
} 