...
class StripeService {
  ...
  Future<void> initialize() async {
    try {
      ...
      final publishableKey = kDebugMode ? _publishableKeyTest : _publishableKeyLive;
  ...
  static const String _createPaymentIntentEndpoint = '$_baseUrl/create-payment-intent';
  static const String _createSubscriptionEndpoint = '$_baseUrl/create-subscription';
  static const String _cancelSubscriptionEndpoint = '$_baseUrl/cancel-subscription';
  static const String _updateSubscriptionEndpoint = '$_baseUrl/update-subscription';
