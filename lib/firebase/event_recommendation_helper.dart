...
class EventRecommendationHelper {
  ...
  static const double personalizationWeight = 0.35;
  static const double popularityWeight = 0.20;
  static const double recencyWeight = 0.10;
  static const double featuredWeight = 0.10;
  ...
  static Future<List<EventModel>> getPersonalizedRecommendations({
    ...
    try {
      ...
      Logger.error('Error in getPersonalizedRecommendations: $e');
      return await _getBasicRecommendations(searchQuery, categories, limit);
    }
  }
  ...
  static Future<List<EventModel>> _fetchEventsFromFirestore(
    ...
    try {
      ...
      Logger.error('Error fetching events from Firestore: $e');
      return [];
    }
  }
  ...
  static Future<double> _calculateLocationScore(
    ...
    try {
      ...
      Logger.error('Error calculating location score: $e');
      return 0.5;
    }
  }
  ...
  static double _calculatePersonalizationScore(
    ...
    // List<String> userPastEventIds = userPreferences['pastEventIds'] ?? []; // Unused variable
  ...
  static Future<Map<String, dynamic>> _getUserPreferences(String userId) async {
    ...
    try {
      ...
      // Map<String, dynamic> userData = userDoc.data() as Map<String, dynamic>; // Unused variable
  ...
  static Future<List<EventModel>> _getBasicRecommendations(
    ...
    try {
      ...
      Logger.error('Error getting basic recommendations: $e');
      return [];
    }
  }
