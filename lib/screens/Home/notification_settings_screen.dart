...
class _NotificationSettingsScreenState
    extends State<NotificationSettingsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _requestPermission() async {
    ...
    setState(() {
      _hasPermission = result.authorizationStatus == AuthorizationStatus.authorized;
    });
    if (!mounted) return;
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _buildSectionHeader('Communication', Icons.chat_bubble_outline_rounded),
                    _buildCommunicationSection(),
                    
                    const SizedBox(height: 8),
                    
                    // Activity Section
                    _buildSectionHeader('Activity', Icons.notifications_active_outlined),
  ...
  Widget _buildMasterToggle() {
    final allEnabled = _settings!.eventReminders && 
                       _settings!.newEvents && 
