...
class _EventsListState extends State<EventsList> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemCount: _filteredEvents.length + (_hasMore && widget.searchQuery.isEmpty ? 1 : 0),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.searchQuery.isEmpty ? 'No Events Available' : 'No Events Found',
              style: const TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.w600,
                color: Color(0xFF1E293B),
