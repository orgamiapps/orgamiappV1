...
class PostCommentsModal extends StatefulWidget {
  ...
  final String organizationId; // Used for feed posts
...
class _PostCommentsModalState extends State<PostCommentsModal> {
  ...
  // Get the correct Firestore paths based on post type
  ...
  CollectionReference get _commentsCollection {
    return _postCollection.doc(widget.postId).collection('Comments');
  }
