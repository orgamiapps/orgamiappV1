...
class _GroupAnalyticsDashboardScreenState extends State<GroupAnalyticsDashboardScreen>
    ...
    try {
      ...
      setState(() {
        _aggregatedAnalytics = {
          ...
          'totalRevenue': 0.0,
          'averageAttendance': 0.0,
          'upcomingEvents': _groupEvents.where((e) => e.selectedDateTime.isAfter(DateTime.now())).length,
          'pastEvents': _groupEvents.where((e) => e.eventEndTime.isBefore(DateTime.now())).length,
          'activeEvents': 0,
          'totalTicketsSold': 0,
          'totalTicketRevenue': 0.0,
            ...
            return [
              SliverAppBar(
                ...
                bottom: TabBar(
                  ...
                  unselectedLabelColor: AppThemeColor.pureWhiteColor.withValues(alpha: 0.7),
  ...
  Widget _buildMetricsSection() {
    final metrics = [
      ...
      },
      {
        ...
        'value': '${(_aggregatedAnalytics['averageAttendance'] as double).toStringAsFixed(1)}',
        'icon': Icons.trending_up,
        'color': Colors.teal,
      },
      {
        'title': 'Retention Rate',
        'value': '${(_aggregatedAnalytics['retentionRate'] ?? 0.0).toStringAsFixed(1)}%',
        'icon': Icons.repeat,
        'color': Colors.indigo,
      },
    ];
  ...
  Widget _buildCategoriesChart() {
    final categories = _aggregatedAnalytics['eventCategories'] as Map<String, int>;
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        if (index >= 0 && index < sortedEntries.length) {
                          final date = DateTime.parse('${sortedEntries[index].key}-01');
                          return Text(
  ...
  Widget _buildTopPerformingEventCard() {
    final event = _aggregatedAnalytics['topPerformingEvent'] as Map<String, dynamic>;
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text(
                  DateFormat('MMM dd, yyyy • HH:mm').format(event.selectedDateTime),
                ),
  ...
  void _askAIQuestion() async {
    ...
    try {
      ...
      setState(() {
        _aiAnswer = 'This feature is being developed. AI-powered Q&A about your group analytics will provide insights about event performance, optimal timing, audience engagement, and recommendations for improvement.';
        _qaLoading = false;
      });
      ...
      setState(() {
        _aiAnswer = 'Sorry, I couldn\'t process your question. Please try again.';
        _qaLoading = false;
      });
    }
  }
