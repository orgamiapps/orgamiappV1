              ...
              Expanded(
                child: PageView(
                  ...
                  children: [
                    ...
                    StepProfilePhoto(
                      onSkip: () => RouterClass().homeScreenRoute(context: context),
                      onNext: () => _goTo(3),
                    ),
                    StepProfessionalInfo(onSkip: () => _goTo(4), onNext: () => _goTo(4)),
                    StepContacts(
                      onFinish: () => RouterClass().homeScreenRoute(context: context),
                    ),
                  ],
                ),
              ),
