              ...
              child: InkWell(
                ...
                child: Stack(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            ...
                            colors: [
                              Colors.white.withValues(alpha: 0.6 * animationValue),
                              Colors.transparent,
                              Colors.white.withValues(alpha: 0.3 * animationValue),
                            ],
                          ),
                        ),
                      ),
                    ...
                    AnimatedContainer(
                      duration: Duration(milliseconds: (1000 + (animationValue * 2000)).round()),
