...
class _AnalyticsDashboardScreenState extends State<AnalyticsDashboardScreen>
  ...
  Future<void> _loadAggregatedAnalytics() async {
    try {
      ...
      for (final event in _userEvents) {
        try {
          ...
          if (analyticsDoc.exists) {
            ...
            final dropoutRate = eventData['dropoutRate'] ?? 0.0;
      ...
      print('Error loading aggregated analytics: $e');
    }
  }
  ...
  Future<void> _loadGlobalAIInsights() async {
    ...
    try {
      ...
      print('Error loading global AI insights: $e');
    }
  }
        ...
        children: [
          ...
          _aiInsightCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...(_globalAIInsights!.strategyRecommendations ?? [])
                    .map(
  ...
  Widget _buildMonthlyTrendsChart(Map<String, int> monthlyTrends) {
    ...
    for (int i = 0; i < sortedMonths.length; i++) {
      final month = sortedMonths[i].key;
  ...
  Future<void> _exportData() async {
    try {
      ...
      if (monthlyTrends.isNotEmpty) {
        ...
        monthlyTrends.forEach((month, count) {
          csvData.add([month, count.toString()]);
        });
      }
